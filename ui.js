...
export function initUI() {
  return {
    ...
    recallFormElement: document.getElementById('recall-form'),
    recallAnswerElement: document.getElementById('recall-answer'),
    recallSubmitElement: document.getElementById('recall-submit'),
